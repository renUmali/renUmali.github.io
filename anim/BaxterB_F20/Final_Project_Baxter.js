...
lib.ssMetadata = [
		{name:"Final_Project_Baxter_atlas_", frames: [[0,0,1280,1024],[0,1026,1600,602]]},
		{name:"Final_Project_Baxter_atlas_2", frames: [[932,572,451,632],[1504,457,54,62],[1504,0,190,455],[405,1206,174,177],[1696,0,222,180],[1895,368,138,179],[1696,397,197,161],[1861,182,168,184],[0,872,601,332],[1385,1143,515,166],[0,1206,403,211],[1696,182,163,213],[1920,0,54,62],[1920,64,54,62],[1976,0,54,62],[1976,64,54,62],[932,0,570,570],[0,0,930,870],[1385,866,545,275],[1385,572,515,292]]}
];
...
(lib.CachedTexturedBitmap_1 = function() {
	this.initialize(ss["Final_Project_Baxter_atlas_2"]);
	this.gotoAndStop(0);
...
(lib.headphones_PNG7640 = function() {
	this.initialize(ss["Final_Project_Baxter_atlas_"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
// stage content:
(lib.Final_Project_Baxter = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Final_Project_Baxter_atlas_.png?1608507622339", id:"Final_Project_Baxter_atlas_"},
		{src:"images/Final_Project_Baxter_atlas_2.png?1608507622340", id:"Final_Project_Baxter_atlas_2"},
		{src:"sounds/song.mp3?1608507622374", id:"song"}
	],
	preloads: []
};
